    ...
    do 
        ...
        do
            CUDA_VISIBLE_DEVICES=0 python main.py \
                ...
                --omics_dir datasets_csv/raw_rna_data/${TYPE_OF_PATH}/${STUDY} --results_dir results_surv_plugin_${STUDY}_b32_e20_gat_midf1 \
                --batch_size 1 --batch_sizes 32 --lr $lr --opt radam --reg $decay \
                ...
                --encoding_layer_1_dim ${DIM1} --encoding_layer_2_dim ${DIM2} --encoder_dropout 0.25 --load_model --checkpoint_path /home/ubuntu/disk1/wys/data/survival/data/results_ori/results_stad/tcga_stad__nll_surv_a0.5_lr1e-03_l2Weight_1e-05_5foldcv_b1_survival_months_dss_dim1_1024_patches_4096_wsiDim_256_epochs_2_fusion_None_modality_survpath_pathT_combine
        done 
    done
done 