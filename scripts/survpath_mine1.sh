    ...
    do 
        ...
        do
            CUDA_VISIBLE_DEVICES=1 python main.py \
                ...
                --omics_dir datasets_csv/raw_rna_data/${TYPE_OF_PATH}/${STUDY} --results_dir results_surv_plugin_${STUDY}_e20_gat_midf \
                --batch_size 1 --lr $lr --opt radam --reg $decay \
                --alpha_surv 0.5 --weighted_sample --max_epochs 20 --encoding_dim 1024 \
                --label_col survival_months_dss --k 5 --bag_loss nll_surv --n_classes 4 --num_patches 4096 --wsi_projection_dim 256 \
                --encoding_layer_1_dim ${DIM1} --encoding_layer_2_dim ${DIM2} --encoder_dropout 0.25 --load_model --checkpoint_path /home/ubuntu/disk1/wys/data/survival/data/results_ori/results_hnsc/tcga_hnsc__nll_surv_a0.5_lr1e-03_l2Weight_0.01_5foldcv_b1_survival_months_dss_dim1_1024_patches_4096_wsiDim_256_epochs_2_fusion_None_modality_survpath_pathT_combine
        done 
    done
done 