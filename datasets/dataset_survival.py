...
class SurvivalDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.modality in ['omics', 'snn', 'mlp_per_path']:
            ...
            return (torch.zeros((1,1)), omics_tensor, label, event_time, c, clinical_data,slide_ids[0])
        ...
        #@TODO what is the difference between tmil_abmil and transmil_wsi
            ...
            return (patch_features, omics_tensor, label, event_time, c, clinical_data, mask,slide_ids[0])
            ...
            return (patch_features, omic1, omic2, omic3, omic4, omic5, omic6, label, event_time, c, clinical_data, mask,slide_ids[0])
        
        elif self.modality in ["survpath", "survpath_mine"]:
            patch_features, mask = self._load_wsi_embs_from_path(self.data_dir, slide_ids)
            #原图片通道
            ...
            return (patch_features, omic_list, label, event_time, c, clinical_data, mask,slide_ids[0])
